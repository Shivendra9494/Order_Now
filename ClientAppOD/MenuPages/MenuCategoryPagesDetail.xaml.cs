...
namespace ClientAppOD.MenuPages
{
    ...
    public partial class MenuCategoryPagesDetail : ContentPage
    {
        ...
        public MenuCategoryPagesDetail()
        {
            InitializeComponent();
        ...
        private static StackLayout addStamp(string textDiscount, bool IsSelected = false, bool onlive = false)
        {
            ...
            {
                Source = ImageSource.FromFile("starGray.png"),
            ...
            if (IsSelected)
            {
                btn.Source = ImageSource.FromFile("star.png");
